...
import Modules.Output.PrintToTxt;
import Modules.Input.FilesLoader;
import Util.Paths;
import java.util.ArrayList;

public class PreProcessedCorpusGenerator {
   
    public static void main(String[] args) {
         ArrayList<Abstract> list = FilesLoader.loadTrainingData(Paths.CORPUS_SWT);
         generatePreProcessedCorpus(list);
       
    }
    
    public static void generatePreProcessedCorpus(ArrayList<Abstract> absList) {
        //remove symbols
        ...
        PrintToTxt.exportIndividualTxtFiles("C:\\Users\\USER\\Dropbox\\2016_01 Orientação Vinicius dos Santos\\05_Código\\JavaTextMiner\\test\\Resources\\PreProcessedCorpus\\SoftwareTest", numbersTreated);
    }
